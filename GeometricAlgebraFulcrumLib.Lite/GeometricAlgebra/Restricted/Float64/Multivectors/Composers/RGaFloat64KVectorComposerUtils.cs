...
namespace GeometricAlgebraFulcrumLib.Lite.GeometricAlgebra.Restricted.Float64.Multivectors.Composers
{
    public static class RGaFloat64KVectorComposerUtils
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RGaFloat64HigherKVector CreateHigherKVector(this RGaFloat64Processor metric, int grade, ulong index, double scalar)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RGaFloat64HigherKVector CreateHigherKVector(this RGaFloat64Processor metric, IReadOnlyList<int> basisVectorIndexList)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RGaFloat64HigherKVector CreateHigherKVector(this RGaFloat64Processor metric, IReadOnlyList<int> basisVectorIndexList, double scalar)
        {
            var id = basisVectorIndexList.BasisVectorIndicesToBasisBladeId();
            var grade = id.Grade();
