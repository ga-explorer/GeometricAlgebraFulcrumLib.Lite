...
public sealed class RGaConformalSpace4D :
    RGaConformalSpace
{
    public static RGaConformalSpace4D Instance { get; } = new RGaConformalSpace4D();


    public RGaFloat64KVector Eo12 { get; }

    public RGaFloat64KVector E12i { get; }
    ...
    private RGaConformalSpace4D() : base(4)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaFloat64KVector EncodePointOpns(double pointX, double pointY)
    {
        var p1 = EncodePoint(pointX, pointY);

        return p1.Op(Ei);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public RGaFloat64KVector EncodePointOpns(Float64Vector2D point)
    {
        var p1 = EncodePoint(point);
