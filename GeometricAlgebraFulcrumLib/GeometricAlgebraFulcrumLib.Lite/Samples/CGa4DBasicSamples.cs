...
public static class CGa4DBasicSamples
{
    ...
    public static void PointsExample()
    {
        ...
        Console.WriteLine("CGA Point 1:" + cga.ToLaTeX(cgaPoint1));
        Console.WriteLine("CGA Point 2:" + cga.ToLaTeX(cgaPoint2));
    ...
    public static void CirclesExample()
    {
        ...
        Console.WriteLine("CGA Circle 1:" + cga.ToLaTeX(cgaCircle1));
        Console.WriteLine("CGA Line:" + cga.ToLaTeX(cgaLine));
        Console.WriteLine("CGA Circle 2:" + cga.ToLaTeX(cgaCircle2));
        Console.WriteLine();
